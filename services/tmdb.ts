...
const UNIQUE_SPORTS = [
  ...
  },
  {
    ...
    overview:
      "Live Formula 1 Grand Prix. Follow all the racing action from the track.",
  },
];
...
const UNIQUE_TV_LIVE = [
  {
    ...
    overview:
      "Watch the FX Movie Channel live in high definition. Enjoy a wide range of movies and TV shows from various genres, all in stunning HD quality.",
  },
  {
    id: "hbo-usa-hd",
    ...
    overview:
      "Live music channel featuring concerts, music videos, and live performances.",
  },
  {
    id: "live-3",
  ...
  },
  {
    ...
    overview:
      "24/7 kids entertainment with cartoons, educational shows, and fun content.",
  },
  {
    id: "live-5",
