...
export const UNIQUE_SPORTS: MediaItem[] = [
  {
    ...
    overview: "Coming Soon: Server are getting ready to stream live sports content. Stay tuned for thrilling matches and exciting sports action, all available in high definition on Vega Movies Official.",
  }
...
export const UNIQUE_TV_SHOWS: MediaItem[] = [
  ...
  },
  {
    ...
    media_type: 'tv',
    streams: {
      "Server 1": "https://stmix.io/e/euvvLY1BD8F7",
