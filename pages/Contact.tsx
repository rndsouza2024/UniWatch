...
const Contact: React.FC = () => {
  ...
  const schema = {
    ...
    "url": "https://official-vegamovies.vercel.app/contact"
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-1 space-y-6">
                <div className="bg-miraj-gray border border-white/5 p-6 rounded-xl">
                    ...
                    <a href="mailto:support@vegamoviesofficial.com" className="text-miraj-red hover:underline font-medium">support@Vega Movies™ Official.com</a>
                </div>
                ...
                <div className="bg-miraj-gray border border-white/5 p-6 rounded-xl">
                    ...
                    <a href="mailto:legal@vegamoviesofficial.com" className="text-miraj-red hover:underline font-medium">legal@Vega Movies™ Official.com</a>
                </div>
            </div>
