          ...
          {videoEnhancement && (
            <div className="flex items-center gap-2">
              <select
                ...
                className="bg-brand-500 text-white text-xs font-bold border border-brand-600 rounded-lg px-2.5 py-1.5 sm:py-1.5 focus:outline-none focus:border-brand-700 focus:ring-2 focus:ring-brand-400/40 transition-all hover:bg-brand-400 min-w-[100px]"
              >
          ...
          {streams.length > 1 && (
            <div className="flex items-center gap-2">
              ...
              <select
                value={activeServer}
                onChange={(e) => setActiveServer(Number(e.target.value))}
                className="bg-amber-500 text-black text-xs font-bold border border-amber-600 rounded-lg px-2.5 py-1.5 sm:py-1.5 focus:outline-none focus:border-amber-700 focus:ring-2 focus:ring-amber-400/40 transition-all hover:bg-amber-400 min-w-[100px]"
              >
                {streams.map((stream, index) => (
                  <option key={stream.id} value={index} className="bg-black text-amber-400 font-semibold">
                    {stream.name}
