        ...
        <div className="container mx-auto px-3 sm:px-4 h-full flex items-center justify-between">
          ...
          >
            ...
            <span className="text-lg sm:text-xl md:text-2xl font-black tracking-tighter text-white">
              Vega Movies<span className="text-miraj-red"> Official</span>
            </span>
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-1">
            ...
            <a
              href="https://median.co/share/abeeoyo"
              target="_blank"
        ...
        <div className="flex flex-col h-full pt-16 sm:pt-20 px-4 sm:px-6 pb-8 sm:pb-12 overflow-y-auto">
          ...
          <div className="mb-6 sm:mb-8 border-b border-white/10 pb-3 sm:pb-4">
             <div className="flex items-center gap-2">
                ...
                <span className="text-base sm:text-lg font-black tracking-tighter text-white">Vega Movies MENU</span>
             </div>
          </div>
          ...
          <div className="mt-6 sm:mt-8 text-center">
             ...
             <p className="text-[9px] sm:text-[10px] font-black text-gray-600 uppercase tracking-[0.5em] sm:tracking-[0.6em]">Vega Movies Official</p>
          </div>
        </div>
      </aside>
    </>
